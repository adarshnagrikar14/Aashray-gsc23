...
import 'package:aashray/Classes/provide_aashray/provide_aashray_two.dart';
...
class ProvideAashrayOne extends StatefulWidget {
  const ProvideAashrayOne({super.key});

  @override
  State<ProvideAashrayOne> createState() => _ProvideAashrayOneState();
}

class _ProvideAashrayOneState extends State<ProvideAashrayOne> {
  // Controllers
  ...
  void saveAndNext(String name, String address, String number,
    ...
    if (name.isNotEmpty &&
      ...
      Reference reference = storage.ref().child("$userId-vDoc.jpg");
      ...
      uploadTask.whenComplete(
        () async {
          ...
          FirebaseFirestore.instance.collection("Aashrays").doc(userId).set({
            "Name": name,
            "Address": address,
            "Mobile": number,
